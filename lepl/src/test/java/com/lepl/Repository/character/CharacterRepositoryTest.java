...
class CharacterRepositoryTest {
  ...
  // 롤백 false 이므로 insert 쿼리까지 전송 - flush() 강제로 써도 로그 볼 수 있지만 "삭제" 에 사용위해 false
...
//        em.flush(); // 강제 flush -> findCharacterWithMember 는 DB 에서 검색하기 때문에 먼저 flush() 진행
    ...
    log.info("findCharacter2 id : {}, member2.getCharacter() id : {}", findCharacter2.getId(),
        member2.getCharacter().getId());
