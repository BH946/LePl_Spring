...
public class Character {
  ...
  public void addCharacterItem(CharacterItem characterItem) {
    ...
    this.characterItems.add(
        characterItem); // Character(엔티티)의 characterItems 리스트에 CharacterItem(엔티티)추가
  }
...
//  }
   ...
   * 생성 편의 메서드
   */
  public static Character createCharacter(Exp exp, List<CharacterItem> characterItems,
      List<Follow> follows, List<Notification> notifications) {
